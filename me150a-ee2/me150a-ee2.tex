...
\begin{frame}{Running time and memory bounds}
  \begin{columns}[T]
    \begin{column}{.6\textwidth}
      should a (quick) section on running time and memory constraints be included?
    \end{column}
...
\begin{frame}{Event detection}
  \begin{columns}[T]
    \begin{column}{.6\textwidth}
      May want to respond to external events \newline
      Two main methods:
      \begin{itemize}
        \item Polling
